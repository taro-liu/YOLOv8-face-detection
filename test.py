...
def parse_variables():
    ...
    parser.add_argument('-w', '--weights', type=str, help='Path to trained weights',
                        default='/data/hdd0/yuteng.liu/YOLOv8-Face/yolov8l_100e.pt')
    ...
    parser.add_argument('-i', '--input', nargs='+', help='Sample input image path',
                        default=['/data/hdd0/yuteng.liu/YOLOv8-Face/test_images/test_1.jpg'])

    parser.add_argument('-o', '--output', nargs='+', help='Sample output image path',
                        default=['/data/hdd0/yuteng.liu/YOLOv8-Face/test_images/test_1_output.jpg'],)
